module SurveysHelper
  ...
  def add_question(f)
    update_page do |page|
      page<<'qid += 1;'
      page<< 'new_question = "<li>  <label>Question</label>  <input type=\"text\" size=\"30\" name=\"survey[questions_attributes]["+qid+"][question]\" id=\"survey_questions_attributes_"+qid+"_question\"><br />  <label>Help</label> <input type=\"text\" size=\"30\" name=\"survey[questions_attributes]["+qid+"][help]\" id=\"survey_questions_attributes_"+qid+"_help\"><br />  <label for=\"survey_questions_attributes_"+qid+"_type\">Type</label>     <ul>      <li>        <input id=\"survey_questions_attributes_"+qid+"_type_multiplechoicequestion\" name=\"survey[questions_attributes]["+qid+"][type]\" type=\"radio\" value=\"MultipleChoiceQuestion\" />        <label for=\"survey_questions_attributes_"+qid+"_type_multiplechoicequestion\">Single answer from multiple options.</label> 	</li>	<li>	  <input id=\"survey_questions_attributes_"+qid+"_type_multipleanswerquestion\" name=\"survey[questions_attributes]["+qid+"][type]\" type=\"radio\" value=\"MultipleAnswerQuestion\" />	  <label for=\"survey_questions_attributes_"+qid+"_type_multipleanswerquestion\">Multiple answers from multiple options.</label> </li>      </ul>  <a id=\"question_"+qid+"_link\" onclick=\"add_option("+qid+"); return false;\" href=\"#\">Add Option</a><ul id=\"question_"+qid+"\"></ul></li>";'
